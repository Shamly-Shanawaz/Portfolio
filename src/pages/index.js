  ...
  return (
    <>
      ...
      <main className='flex items-center text-dark w-full min-h-screen dark:text-light '>
        <Layout className='pt-0 md:pt-0 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
              <div className='w-1/2 md:mb-2 md:mr-5'>
                <Image src={proPic} alt="shamly" className='w-full h-auto lg:hidden md:inline-block md:w-full'
